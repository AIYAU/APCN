...
# 导入few-shot学习方法和模型
from easyfsl.methods import TransductiveFinetuning, FewShotClassifier
...
few_shot_classifier = TransductiveFinetuning(backbone=convolutional_network).to(DEVICE)
